...
public class Game {
    ...
    private void placeInitial(){
        ...
        //for both color, black and white, do the followingg
        ...
        for(int q = 0;q<pieces.size();q++){
            ...
            for(int i = 0;i<64;i++){
                //check for every square if a piece is on it. if so, set to occupied        to string is needed, otherwise I cant compares enum? so i have to take the first of the array initialposition which is the x-axis, convert and the compar eit
